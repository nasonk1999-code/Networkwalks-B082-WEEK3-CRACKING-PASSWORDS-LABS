...
2.	Add john.exe file to the Johnny GUI
	<img width="873" height="663" alt="Screenshot 2026-08-29 225048" src="https://github.com/user-attachments/assets/37f3a273-4fe0-4bae-82af-a312eeb5a1fc" />
...
6. Use the copied word from notepad and run the saved value upload it on john the ripper
...
This project was completed as part of the Networkwalks Cybersecurity & Ethical Hacking training program.

Thanks to the Networkwalks training team and mentors for the hands-on exercises, structured modules, and guidance throughout the internship.

The project provided direct, practical exposure to industry-relevant reconnaissance, OSINT, and network-scanning techniques in an authorized educational setting.

Mentor: Waqas Karim, CCIE — Cybersecurity Professional, Networkwalks

Grateful for the guidance and hands-on learning provided throughout the program.
